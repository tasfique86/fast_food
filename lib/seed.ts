...
//   try {
//     // 1️⃣ Create a local path inside Expo's cache
...
//     // 2️⃣ Download remote image to local file
//     const downloadResult = await FileSystem.downloadAsync(imageUrl, localUri);

//     // 3️⃣ Upload to Appwrite from local file
//     const file = await storage.createFile(
//       appwriteConfig.bucketId,
//       ID.unique(),
//       downloadResult.uri // ← local file path (file://...)
//     );

//     // 4️⃣ Return public view URL
